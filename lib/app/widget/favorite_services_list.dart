...
class FavoriteServicesList extends StatefulWidget {

  const FavoriteServicesList({Key? key, required this.servicesList,}) : super(key: key);

  final List<Services> servicesList;

  @override
  State<FavoriteServicesList> createState() => _FavoriteServicesListState();
}

class _FavoriteServicesListState extends State<FavoriteServicesList> {
                            ...
                            Expanded(
                              ...
                              child: GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: Align(
                                    alignment: Alignment.topRight,
                                    child: services.isFavorite == false ? SvgPicture.asset(
