...
class UploadJobPage extends StatefulWidget {
  UploadJobPage({Key? key}) : super(key: key);
...
int toggle = 0;
class _UploadJobPageState extends State<UploadJobPage> with SingleTickerProviderStateMixin {
        ...
        Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10,),
              // danh sách công việc đã tạo mới
              Expanded(
                flex: 2,
